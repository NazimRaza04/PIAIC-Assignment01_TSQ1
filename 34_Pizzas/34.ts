...
let favorite_pizzas = ["Habanero Pizza", "Ranch Pizza", "Tikka Pizza"];

favorite_pizzas.forEach((c) => console.log(c));

favorite_pizzas.forEach((n) => console.log(`i like ${n}`));

favorite_pizzas.forEach((p, i) => console.log(`i like ${p}`, `, I really love it!`));